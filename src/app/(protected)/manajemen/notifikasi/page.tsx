...
export default async function ManagementNotificationsPage() {
  ...
  return <DashboardLayout role="manajemen"><ContentShell><PageHeader title="Notifikasi" description={`Pembaruan yang perlu ditinjau untuk penanganan laporan, ${user.name}.`} /><ManagementNotificationList /></ContentShell></DashboardLayout>
}
