...
export default async function ManagementStatisticsPage() {
  ...
  return <DashboardLayout role="manajemen" user={user}><ContentShell><PageHeader title="Statistik" description={`Analisis performa, tren, dan prioritas penanganan operasional JTI, ${user.name}.`} /><ManagementStatistics /></ContentShell></DashboardLayout>
}
